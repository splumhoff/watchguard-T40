...
#define DHCP_AUTH               0x5a /* RFC 3118.authentication for DHCP mesages */
...
/* DHCP message authentication (RFC 3118) defines. */
#define DHCPAUTH_MIN_LEN            11      /* Minium length of a DHCP_AUTH option. */
#define DHCPAUTH_PROTO_TOKEN        0x00    /* Authentication protocol for token. */
#define DHCPAUTH_ALG_TEXT           0x00    /* Plain text token algorithm. */
#define DHCPAUTH_RDM_MONOCOUNTER    0x00    /* monotonic counter RDM. */
...
#define DHCPFORCERENEW          9 /* client <- server */
#define DHCP_MINTYPE DHCPDISCOVER

/* WG -- we did NOT change DHCP_MAXTYPE when we added DHCPFORCERENEW.
 * This is referenced only in dhcp server, and DHCPFORCERENEW
 * pertains only to client.  
 */
