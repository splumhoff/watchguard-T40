...
//kbuild:lib-$(CONFIG_GETTY) += getty.o disclaimer.o
...
static char *get_logname(void)
{
	...
	do {
		/*WatchGuard: Prompt for disclaimer
		* When logon banner enabled/configured, the disclaimer will be displayed
		* and demand acknowledgement before user can input username and password
		*/
		display_disclaimer();
