...
#ifdef	CONFIG_WG_PLATFORM // WG:JB Add counters for entering loss state
	LINUX_MIB_TCPENTERLOSS0,		/* TCP Enter Loss How==0 */
	LINUX_MIB_TCPENTERLOSS1,		/* TCP Enter Loss How==1 */
#endif
#ifdef	CONFIG_WG_PLATFORM_BACKPORT // WG:DW FBX-16849
