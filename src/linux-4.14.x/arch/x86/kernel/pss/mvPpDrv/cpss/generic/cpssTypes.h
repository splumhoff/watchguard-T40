 ...
 *                     APPLICABLE DEVICES: Puma2, Puma3, DxCh1, DxCh1_Diamond, DxCh2, DxCh3, xCat, Lion, xCat2, Lion2, Lion3.
 ...
 *        CPSS_PP_FAMILY_DXCH_LION2_E   - (DXCH) Lion 2 family devices  NOTE: must be > then CPSS_PP_FAMILY_DXCH_XCAT2_E
 *        CPSS_PP_FAMILY_DXCH_LION3_E   - (DXCH) Lion 3 family devices  NOTE: must be > then CPSS_PP_FAMILY_DXCH_LION2_E
...
/* start Lion3 devices */
/**********************/
#define    CPSS_98CXEEEF_CNS    0xEEEF11AB    /* dummy for simulation - Lion3 device  */
...
#define PRV_CPSS_DEVICE_QUIRKS_PEX_0x00000_ENTRY_MAC(pciId) \
    PRV_CPSS_DEVICE_QUIRKS_PEX_ENTRY_MAC(pciId,0x00000)
...
/* lion3 devices with port groups 0,1,2,3,4,5,6,7 */
...
/* lion2,lion3 devices with 3 mini-gop's per port group */
#define    CPSS_LION_2_3_THREE_MINI_GOPS_DEVICES_CASES_MAC  \
         CPSS_98CX8296_CNS:                                 \
    case CPSS_98CX8308_CNS

/* lion2,lion3 devices with 4 mini-gop's per port group */
...
/* lion3 devices with port groups 0,1,2,3,4,5,6,7 -- for switch-case*/
#define CPSS_LION3_PORT_GROUPS_01234567_DEVICES_CASES_MAC  \
    /*caller start with 'case' */                     \
         CPSS_98CXEEEF_CNS    /*caller end with ':' */

/* lion3 All devices -- for switch-case*/
