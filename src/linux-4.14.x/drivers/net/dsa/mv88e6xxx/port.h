...
#endif // ifdef CONFIG_WG_PLATFORM_M390 || M590_M690
...
#define MV88E6XXX_PORT_BASE_VLAN_FORCE_MAP  	0x0800
#endif
...
#ifdef CONFIG_WG_PLATFORM_DSA_MODE_T80
int mv88e6xxx_port_get_led_value(struct mv88e6xxx_chip *chip, int port, u16 *value);
int mv88e6xxx_port_set_led_value(struct mv88e6xxx_chip *chip, int port, u16 value);
#endif /* ifdef CONFIG_WG_PLATFORM_DSA_MODE_T80 */
