...
struct e1000_adapter {
...
#ifdef CONFIG_WG_PLATFORM	// WG: XD BUG87949
	struct timer_list rxo_timer;
#endif
	...
	u16 eee_advert;
#ifdef	CONFIG_WG_PLATFORM	// WG: XD FBX-2444
#define	RAH_COUNT	16	// # of RAH regs
	u32 cur_rctl;
	u32 cur_rah[RAH_COUNT];
	u32 cur_mta[MAX_MTA_REG];
#endif
};
...
#ifdef CONFIG_WG_PLATFORM // WG: fix for BUG73312
	__E1000_DOWN,
	__E1000_CLOSING,
	__E1000_RX_DISABLED
#else
