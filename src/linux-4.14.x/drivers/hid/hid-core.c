...
#ifdef	CONFIG_WG_PLATFORM      // WG:XD FBX-9450
#define	USB_VENDOR_ID_NOVATELWIRELESS			0x1410
#define	USB_DEVICE_ID_USB730L				0x9030
	{ HID_USB_DEVICE(USB_VENDOR_ID_NOVATELWIRELESS, USB_DEVICE_ID_USB730L) },
#endif
