...
static int sdhci_esdhc_probe(struct platform_device *pdev)
{
...
#ifdef	CONFIG_WG_ARCH_FREESCALE // WG:JB No MMC devices on T35
	if (unlikely(wg_cpu_model == WG_CPU_T1024)) return -ENODEV;
#endif
	...
	host->quirks2 |= SDHCI_QUIRK2_DELAY_BEFORE_DATA_ERR_RECOVERY;
#endif
