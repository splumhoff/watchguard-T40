...
#ifdef CONFIG_WG_PLATFORM  // WG:PE FBX-17082 ... from Lanner patch
#define LTD_HV_REG		0x42	/* Bank 0; 2 regs in VSEN range */
#else
			     ...
			     long *val)
{
	...
	case hwmon_temp_input:
		if (channel == 0)
			...
			ret = nct7904_read_reg16(data, BANK_0, T_CPU1_HV_REG);
#endif
		else
			ret = nct7904_read_reg16(data, BANK_0,
