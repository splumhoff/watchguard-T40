...
#if defined(CONFIG_WG_PLATFORM_DSA_MODULE) || defined (CONFIG_WG_PLATFORM_DSA) // WG:XD WG Patches for M270 still need the API's
/**
...
s32 ixgbe_init_phy_ops_X550em(struct ixgbe_hw *hw)
{
	...
	case ixgbe_phy_x550em_kr:
		...
		phy->ops.read_reg = ixgbe_read_phy_reg_x550em;
		phy->ops.write_reg = ixgbe_write_phy_reg_x550em;
#if defined(CONFIG_WG_PLATFORM_DSA_MODULE) || defined (CONFIG_WG_PLATFORM_DSA) // WG:JB Fix for MDIO issue from Lanner
