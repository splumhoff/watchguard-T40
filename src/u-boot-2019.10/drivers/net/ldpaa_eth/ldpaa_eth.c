...
int switch_mv88e6191X_init(void)
{
	...
	//mv88e6191X_Errata();	//10GBASE-R Serdes initialization procedures
	...
	//xsmi_write(SMI_I, CPU_PORT_10, 0x1e, 0x8101, 0x0be8); //Failure to meet SFF-8431 transmitter jitter requirements
