...
#else
#define CONFIG_SYS_I2C_RTC_ADDR		0x68  /* Channel 0*/
#endif
...
#define NXP_FSPI_FLASH_SIZE		SZ_8M
#else
...
#define CONFIG_ENV_OFFSET		0x200000   // 0x300000
...
#define XSPI_MC_INIT_CMD				\
	...
	"fsl_mc start mc 0x80400000 0x80620000\0"
