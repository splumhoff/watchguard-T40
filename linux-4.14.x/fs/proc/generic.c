...
#ifdef	CONFIG_WG_PLATFORM_OLD_PROC_API // WG:JB Expose this
       const struct inode_operations proc_file_inode_operations = {
#else
...
#ifdef	CONFIG_WG_PLATFORM_OLD_PROC_API // WG:JB Expose this
       struct proc_dir_entry *__proc_create(struct proc_dir_entry **parent,
#else
