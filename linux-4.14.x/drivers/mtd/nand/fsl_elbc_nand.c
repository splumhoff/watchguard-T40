...
static int fsl_elbc_validate_new_reserve_blocks(struct mtd_info *mtd);
#endif
...
#ifdef	CONFIG_WG_PLATFORM
	chip->bbt_reserve_block_fixup = fsl_elbc_validate_new_reserve_blocks;
#endif
...
#ifdef	CONFIG_WG_PLATFORM
/*
 * Dummy function needed for platforms that 
 * do not use the fsl_ifc_nand.c.
 * This function primarilty exists for IFC drivers.
 */  
static int fsl_elbc_validate_new_reserve_blocks(struct mtd_info *mtd)
{
	return 0;
