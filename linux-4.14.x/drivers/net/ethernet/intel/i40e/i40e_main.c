...
static inline u16 wg_i40e_select_queue(struct net_device *net_dev, struct sk_buff *skb,
...
static const struct net_device_ops i40e_netdev_ops = {
	...
	.ndo_xdp		= i40e_xdp,
#ifdef CONFIG_WG_PLATFORM_M390
	.ndo_select_queue       = wg_i40e_select_queue,
#endif
};
...
#define PCI_WIDTH_SIZE 8
	...
	/* setting the default led control. */
	i40e_def_led_set(hw);
#endif
	return 0;
