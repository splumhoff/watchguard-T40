...
#define	CONFIG_WG_PLATFORM_GFAR_TX_ATOMIC 1 // WG:JB Make atomic
...
enum gfar_dev_state {
	GFAR_DOWN = 1,
#ifdef	CONFIG_WG_PLATFORM // WG:JB Add more states
	GFAR_RESETTING,
	GFAR_RX_CLEANING,
	GFAR_TX_CLEANING,
#else
...
#endif
#if defined(CONFIG_WG_PLATFORM_DSA_MODULE) || defined (CONFIG_WG_PLATFORM_DSA) // WG:JB L2 Switch data
	unsigned		wg_L2_off; // L2OFF for RCTRL
