...
#ifdef	CONFIG_WG_KERNEL_4_14_NOT_USED

static int gfar_ethtool_set_link_ksettings(struct net_device *ndev,
					   struct ethtool_link_ksettings *cmd)
{
	...
	cmd->base.maxtxpkt = get_icft_value(tx_queue->txic);
	cmd->base.maxrxpkt = get_icft_value(rx_queue->rxic);
