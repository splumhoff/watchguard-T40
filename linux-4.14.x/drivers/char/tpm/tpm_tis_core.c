...
#ifdef CONFIG_WG_MUKUND_FIX_ME // WG:MJ Bump the timeout if case of ATMEL
		      ...
		      acpi_handle acpi_dev_handle)
{
...
#ifdef CONFIG_WG_MUKUND_FIX_ME // WG:MJ Adjust timeouts
	{
	...
	if (chip->vendor.timeout_adjusted) {
		dev_info(&chip->dev, "Adjusting reported timeouts: A %luus, B %luus, C %luus, D %luus\n",
			 new_timeout[0], new_timeout[1], new_timeout[2], new_timeout[3]);
