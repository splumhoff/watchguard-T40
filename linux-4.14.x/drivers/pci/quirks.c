...
#ifdef CONFIG_WG_PLATFORM_M390
#define PCI_VENDOR_ID_M390		0x1957
#define PCI_VENDOR_ID_M390_ERR_DEV	0x8250
/*
 * Handle special case M390.
 * we need to disable noaer for for all M390 platforms.
 */
static void noaer_for_m390(struct pci_dev *pdev)
{
	dev_info(&pdev->dev, "disabling AER for M390 platform only\n");
	printk("disabling AER for M390 platform only\n");
	pci_no_aer();

}

/* PCI vendor ID for M390 is 'XXXXX' */
// DECLARE_PCI_FIXUP_FINAL(PCI_VENDOR_ID_M390, 0x8250, noaer_for_m390);
DECLARE_PCI_FIXUP_EARLY(PCI_VENDOR_ID_M390, PCI_VENDOR_ID_M390_ERR_DEV, noaer_for_m390);
#endif /* CONFIG_WG_PLATFORM_M390 */
