			       ...
			       unsigned int keylen)
{
	...
	if (rta->rta_type != CRYPTO_AUTHENC_KEYA_PARAM)
		return -EINVAL;
/* WG:LV (FBX-19895)
 * backport patch - 8f9c469348487844328e162db57112f7d347c49f (patch)
 * crypto: authenc - fix parsing key with misaligned rta_len
 * Fix it by restricting the rtattr payload to the expected size.
 * MJ: 0942-crypto-authenc-fix-parsing-key-with-misaligned-rta_l.patch is already as below. Skipping over.
 */
#ifndef CONFIG_WG_PLATFORM_BACKPORT
